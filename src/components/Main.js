...
var App = React.createClass({
  ...
  /**
   * Generic Toggle funciton for search toggle
  ...
  componentDidMount: function(){
     /**
     * Running IntroJs for first load
     */
         ...
         <section id="main" >
            ...
            <div className="">
               ...
               <div className="col-md-3" >
                  ...
                  <div className="row">
                     <div className="col-xs-12 col-sm-12">
                        <div className="panel panel-default" data-step="1" data-intro="Start By Dragging a candidate from this list.">
                           <div className="panel-heading c-list" >
                              <span className="title">Candidates</span>
                              <ul className="pull-right c-controls">
                                 <li data-step="5" data-intro="Want to add a new candidate, no problem!."><a href="#modal-add" data-toggle="tooltip" data-placement="top" title="Add Candidate"><i className="glyphicon glyphicon-plus"></i></a></li>
                                 <li data-step="6" data-intro="Too many candidates? Don't worry. Search is available."><a href="#" id="1" className="hide-search"  data-command="toggle-search"  onClick={this.toggleX.bind(this,'1','cx1')} data-toggle="tooltip" data-placement="top" title="Toggle Search"><i className="fa fa-search"></i></a></li>
                              </ul>
                           </div>

                           <div className="row" id="inpSt">
                              <div className="col-xs-12">
                                 <div className="c-search" id="cx1">
                                    <input type="text" placeholder="Search for candidate" className="form-control" id="contact-list-search1" tabIndex="1"/>
                                    
                                 </div>
                              </div>
                           </div>
                                 <ul  className="list-group" id="contact-list" data-step="7" data-intro="Click On any candidate to modify/delete details (CRUD Ops.)">
                                  <CanList/>
                                 </ul>
               ...
               <div className="col-md-6">
                  <div className="row">
                     <div className="col-md-6">
                        <div className="drop-zone" id="drop-zone-can" data-step="2" data-intro="Drop it at drop-zone. Multiple candidates can be dropped.">
                           Drag and Drop Candidates
                        </div>
                     </div>
                     <div className="col-md-6">
                        <div className="drop-zone" id="drop-zone-int" data-step="4" data-intro="Drop it here.">
               ...
               <div className="col-md-3">
                  ...
                  <div className="row">
                     <div className="col-xs-12 col-md-12">
                        <div className="panel panel-default" data-step="3" data-intro="Drag an interviewer from this list.">
                           <div className="panel-heading c-list" >
                              <span className="title">Interviewers</span>
                              <ul className="pull-right c-controls">
                                 <li><a href="#" id="2" className="hide-search"  data-command="toggle-search" onClick={this.toggleX.bind(this,'2','cx2')} data-toggle="tooltip" data-placement="top" title="Toggle Search"><i className="fa fa-search"></i></a></li>
                              </ul>
                           </div>

                           <div className="row" id="inpSt">
                              <div className="col-xs-12">
                                 <div className="c-search" id="cx2">
